...
1. `AGENTS.md` — non-negotiable project pledges (MIT, no uploads, no tracking, no BYOK, etc.) plus sustainability and independence guidance (low maintainer cost; no sponsors/acquisition framing unless a maintainer directs it).
